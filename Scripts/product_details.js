...
function cool_fun(arr) {
  ...
  arr.map((ele) => {
    ...
    img11.src =
      "https://www.shutterstock.com/shutterstock/photos/2006512574/display_1500/stock-vector-sale-banner-template-design-with-geometric-background-big-sale-special-offer-up-to-off-super-2006512574.jpg";
    img11.setAttribute("class", "img11");
    let img12 = document.createElement("img");
    img12.setAttribute("class", "img11");
    img12.src =
      "https://www.shutterstock.com/shutterstock/photos/771507109/display_1500/stock-vector--off-special-offer-discount-big-sale-promotion-vector-poster-price-discount-offer-design-771507109.jpg";
